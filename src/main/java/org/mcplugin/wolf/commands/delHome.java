...
public class delHome implements CommandExecutor, TabCompleter {
    ...
    public delHome(WolfPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        plugin.getConfig().set("homes." + player.getDisplayName() + "." + homeName, null);
        plugin.saveConfig();
        player.sendMessage(ChatColor.GREEN + "Successfully deleted home " + homeName + "!");
